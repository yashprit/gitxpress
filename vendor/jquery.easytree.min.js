    ...
    var EasyTree = function (jQueryContext, options) {
        ...
        function getNodesAsHtml(nodes, level, display) {
            ...
            for (i = 0; i < nodes.length; i++) {
                ...
                html += forceOpenNode ? '' : n.isFolder ? '<span class="easytree-expander expand-icon"></span>' : '<span class="easytree-expander"></span>';;
        ...
        function getIconHtml(node) {
            ...
            if(node.isFolder) {
                ...
                return '<span class="octicon octicon-file-text"></span>'
            }
        }
        function getTitleHtml(node) {
            ...
            var titleCss = "easytree-title css-truncate css-truncate-target ";
            if (node.textCss) {
            ...
            if (node.href) {
                html += '<a data-pjax class="message" href="' + node.href + '" ';
                if (node.hrefTarget) {
